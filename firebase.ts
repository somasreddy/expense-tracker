...
// ====================================================================================
// ACTION REQUIRED: Firebase Configuration Error
// ====================================================================================
// The `auth/configuration-not-found` error occurs because the Firebase configuration
// below is using placeholder values. You must replace them with your own project's
// credentials.
//
// How to fix this:
// 1. Go to your Firebase project console: https://console.firebase.google.com/
// 2. Select your project (e.g., "expense-tracker-13724").
// 3. Click the gear icon (Project settings) in the top-left corner.
// 4. In the "Your apps" card, find your web app and look for the "SDK setup and
//    configuration" section.
// 5. Select "Config" and copy the entire `firebaseConfig` object.
// 6. Paste your configuration object here, replacing the placeholder object below.
// ====================================================================================
...
const firebaseConfig = {
  ...
  storageBucket: "expense-tracker-13724.firebasestorage.app",
